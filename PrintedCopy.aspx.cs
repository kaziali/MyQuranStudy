...
{
    public partial class PrintedCopy : System.Web.UI.Page
    {
       ...
       // protected string sAllEngTrans = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ShowFullVersion = !Convert.ToBoolean(Request.Params["print"].ToString());
           ...
           // Response.Write(UserID.ToString());
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                while (reader.Read())
                {
                    ...
                    GeneralNote = reader["genNotes"].ToString();
           ...
           // string nextSura = "";
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                while (reader.Read())
                {
                   ...
                   // nextAyah = reader["nextAyah"].ToString();
                    ...
                    //******HTML5 --> use of data attribute: data-wordDetails=
                     if(!string.IsNullOrEmpty(reader["LemmaNote"].ToString().Trim()))
                      stateClass += " HasWordNote";
               ...
               // outhtml += " </span>";
                ...
                prevVersesUrl = "/PrintedCopy.aspx?Page=" + prePg.ToString();
                nextVersesUrl = "/PrintedCopy.aspx?Page=" + nextPage.ToString();
                currVersesUrl = "/PrintedCopy.aspx?Page=" + (prePg + 1).ToString();
